class CarFactory {
  ...
  produksi(year) {
    ...
    console.log(
      `Pada tahun ${year}, perusahaan ${this.brand1} memproduksi sebanyak ${A} mobil, sedangkan perusahaan ${this.brand2} memproduksi sebanyak ${B} mobil`
    );
  }
  ...
  garansi(year) {
    ...
    for (let i = 0; i < this.cars.length; i++) {
      ...
      if (y > this.cars[i].garansi + this.cars[i].yearp) {
        ...
        console.log(
          `Merk: ${this.cars[i].merk} \nModel: ${this.cars[i].model} \nNomor Mesin: ${this.cars[i].mesin}`
        );
        console.log(
          `\nDengan waktu garansi ${
            this.cars[i].garansi
          } tahun, di tahun ${y} garansi sudah TIDAK AKTIF, karena diproduksi pada tahun ${
            this.cars[i].yearp
          } dan sudah habis pada tahun ${
            this.cars[i].garansi + this.cars[i].yearp
          }.\n`
        );
      } else {
        console.log(
        ...
        console.log(
          `\nDengan waktu garansi ${
            this.cars[i].garansi
          } tahun, di tahun ${y} garansi masih AKTIF, karena diproduksi pada tahun ${
            this.cars[i].yearp
          } dan baru akan habis pada tahun ${
            this.cars[i].garansi + this.cars[i].yearp
          }.\n`
        );
      }
